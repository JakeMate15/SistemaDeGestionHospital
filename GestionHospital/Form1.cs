    ...
    public partial class Form1 : Form
    {
        ...
        public void loggin(string usuario, string contrasena){
            ...
            try{
                ...
                SqlCommand comando = new SqlCommand("SELECT Nombre + ' ' + paterno + ' ' + ISNULL(materno,''), idTipoTrabajador FROM Usuario AS u INNER JOIN Empleado AS e ON u.IdEmpleado = e.idEmpleado INNER JOIN Persona AS p ON e.idPersona = p.idPersona where u.idUsuario =@usuario and u.Contraseña=@contrasena",conexion);
                ...
                if (dt.Rows.Count == 1){
                    ...
                    if (dt.Rows[0][1].ToString() == "1"){
                        new Dr(dt.Rows[0][0].ToString()).Show();
                    }

                    //Enfermera
                    else if (dt.Rows[0][1].ToString() == "2"){
                        new Enfermera(dt.Rows[0][0].ToString()).Show();
                    }
